import 'dart:io';
  ...
  /**
   *  5 - No país de Brasilândia a moeda nacional é a merreca (M$). Sabe-se que sistema monetário de Brasilândia só utiliza
   ...
   *  desenvolvimento de um software, escrito em Dart. Dado um valor em merreca, o programa deve calcular qual o número mínimo
...
main() {
  ...
  quant100 ~/= 100; //aqui ele divide o valor por 100, o ~ é utilizado para pegar o valor em inteiro (arredonda para baixo)
  int quant101 = merreca % 100; //pega a variavel recebida pelo usuário e recebe o resto da divisão por 100
