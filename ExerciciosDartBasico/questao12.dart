...
/**
   *  12 - Em uma empresa os funcionários renovam o contrato por três anos. O salário sofrerá um reajuste de 7%, 6% e 5%
...
main() {
  ...
  print("Seu salário daqui um ano será de R\$ $sal1Ano");
  print("Seu salário daqui um dois será de R\$ $sal2Ano");
  print("Seu salário daqui um três será de R\$ $sal3Ano");
}
